...
import blockchain from './Our Services/Blockchain Services/blockchain-bg.png'
      ...
      <section className='serviceSection' style={{ marginTop: '20vh' }}>
        ...
        <div className="card-div d-flex justify-content-center align-item-center my-5">
          ...
          <div className="card text-bg-dark mx-3" data-aos="slide-left">
            <img src={blockchain} className="card-img" alt="..." />
            <div className="card-overlay">
              <Link to="/Services5"><h4 className="card-title" style={{ fontWeight: '600', fontSize: '2.6rem', color: '#fff' }}>Blockchain</h4>
                <h4 className="card-title" style={{ fontWeight: '600', fontSize: '2.6rem', color: '#fff' }}>Technology</h4>
                <p className="card-text " style={{ color: 'grey' }}>We provide comprehensive blockchain technology services including smart contracts, NFTs, and Web3 solutions.</p>
              </Link>
            </div>
          </div>
        </div>
